                    ...
                    if(isset($_GET['id']))
                    {
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select name="state" aria-label="Disabled select example" disabled> 
                                <option selected>Approved(wait Dispatch)</option>  
                            </select>
                        </div>
                        <!-- <div class="form-group mb-3">
                            ...
                            <select id="TypeSelect"> 
                                ...
                                <option>Approved(wait Dispatch)</option>
                                <option>Dispatching</option>
                                <option>Shipped</option>
                                <option>Successfuly Delivered</option>  
                            </select>
                        </div> -->

                        <div class="form-group" mb-3>
                            <button type="submit" name="approve_order" class="btn btn-primary float-start" ><i class="fas fa-plus"></i>Approve Order</button>
                        
                            <button type="submit" name="declining_btn" class="btn btn-danger float-end"><i class="fas fa-trash-alt"></i>Decline Order</button>
                        </div>
                    </form>
                    <?php
                        }else{
